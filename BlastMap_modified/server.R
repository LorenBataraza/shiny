...
library(devtools)
install_url('https://cran.r-project.org/src/contrib/Archive/d3heatmap/d3heatmap_0.6.1.1.tar.gz')

#install.packages("d3heatmap", repos='https://cran.r-project.org/src/contrib/Archive/d3heatmap/d3heatmap_0.6.1.1.tar.gz')

#install.packages('https://cran.r-project.org/src/contrib/Archive/d3heatmap/d3heatmap_0.6.1.1.tar.gz', type = 'source')
